...
/*   Updated: 2019/04/01 14:33:29 by tmeyer           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		*get_oldpwd(t_env *environ, char *str)
{
	ft_memdel((void**)&str);
	if (!environ->oldpwd || !(str = ft_strdup(environ->oldpwd + 7)))
		ft_putendl_fd("NO OLDPWD", 2);
	if (str)
		ft_putendl(environ->oldpwd + 7);
	return (str);
}
